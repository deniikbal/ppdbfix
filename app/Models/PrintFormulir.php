...
class PrintFormulir extends Fpdf
{
    ...
    {
        //$image = asset('assets/img/logots.png', 'r', 'false');
        $gambar = 'https://smktelkom-pwt.sch.id/wp-content/uploads/2019/02/logo-telkom-schools-bundar-1024x1024.png';
        $this->SetFont('Arial', '', 12);
        $this->Image($gambar, 5, 5, -750);
