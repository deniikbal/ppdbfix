            ...
            <div class="card bd-0 bd-md-x bd-md-y card-body mg-t-10 mb-2">
                <div class="media">
                    <span class="tx-color-05"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            stroke-linejoin="round" class="feather feather-book-open wd-60 ht-60">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td> <span class="text-uppercase badge badge-primary font-weight-bold">Akte Lahir</span>
                                    <br>
