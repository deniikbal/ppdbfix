                ...
                <div class="container">
                    <form action="{{ route('updateorangtua', $student->uuid) }}" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label>Tempat Lahir Ayah: <span class="tx-danger">*</span></label>
                                <input id="lastname" class="form-control @error('tempat_lahir_ayah') is-invalid
                                @enderror"
                                       name="tempat_lahir_ayah" type="text" value="{{ old('tempat_lahir_ayah',
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input id="lastname" class="form-control @error('tahun_ayah') is-invalid @enderror"
                                       name="tahun_ayah" type="date"
                                       value="{{ old('tahun_ayah', $student->tahun_ayah) }}">
                                @error('tahun_ayah')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label>Tempat Lahir Ibu: <span class="tx-danger">*</span></label>
                                <input id="lastname" class="form-control @error('tempat_lahir_ibu') is-invalid
                                @enderror"
                                       name="tempat_lahir_ibu" type="text" value="{{ old('tempat_lahir_ibu',
