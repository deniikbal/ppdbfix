                                    ...
                                    <ul class="pd-l-10 mg-0 mg-t-20 tx-13">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <li class="font-weight-bold">Jenis Kelamin : {{ $student->jenis_kelamin }}
                                                </li>
                                                <li class="font-weight-bold">Tempat Lahir : {{ $student->tempat_lahir }}
                                                </li>
                                                <li class="font-weight-bold">Tanggal Lahir : {{ $student->tanggal_lahir }}
                                                </li>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <li class="font-weight-bold">Tinggi Badan : {{ $student->tinggi_badan }}
                                                </li>
                            ...
                            <div class="card-body pd-25">
                                <div class="media d-block d-sm-flex">
                                    ...
                                    <div class="media-body pd-t-25 pd-sm-t-0 pd-sm-l-25">
                                        ...
                                        <p class="mg-b-3 tx-color-02"><span class="tx-medium tx-color-01">Jika ada
                                                Kesalahan Biodata Orang Tua, silahkan untuk mengedit dengan mengklik tombol
                                                edit</span></p>
                                        <span class="d-block tx-13 tx-color-03">PPDB SMA TELKOM BANDUNG
                                            {{ Carbon\Carbon::now()->format('Y') }}</span>
                            ...
                            <div class="media d-block d-sm-flex">
                                ...
                                <div class="media-body pd-t-25 pd-sm-t-0 pd-sm-l-25">
                                    ...
                                    <ul class="pd-l-10 mg-0 mg-t-20 tx-13">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <li class="font-weight-bold">Alamat Rumah : {{ $student->alamat_pd }}</li>
                                                <li class="font-weight-bold">Jarak : {{ $student->jarak . ' ' . 'Km' }}
                                                </li>
